...
import '../css/Mainproj1-homeComponent.css';

class Mainproj1home extends Component{
    ...
    render(){
        return(
            ...
            <div className='row mainproj1' id="mainproj1">
            <div className="col">
            <div className="row">
            ...
            <div className="col-6 relvect">
            </div>
            </div>
            <div className="row svgpattern">
            </div>
            </div>
            </div>
            </React.Fragment>
